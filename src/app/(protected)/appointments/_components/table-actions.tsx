...
import { deleteAppoointment } from "@/actions/delete-appointment";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export const AppointmentsTableActions = ({
  ...
  const deleteAppoointmentAction = useAction(deleteAppoointment, {
    onSuccess: () => {
  ...
  const handleDeleteAppointmentClick = () => {
    ...
    deleteAppoointmentAction.execute({ id: appointment.id });
  };
